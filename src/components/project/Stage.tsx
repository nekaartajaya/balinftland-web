...
const ProjectStage = ({title, subtitle, desc, image}: Stage) => {
  return (
    <div className="flex flex-col gap-y-6 text-blue italic py-10">
      <div className="flex justify-between items-center gap-x-2 font-bold relative">
        <h1 className="w-4/5 text-[32px] ">{title}</h1>
        <h1 className="w-1/5 text-right text-[64px] opacity-20">{subtitle}</h1>
